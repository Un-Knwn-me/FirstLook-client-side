...
const Cart = () => {
    ...
    const { cartItems, userAddress } = useSelector(state => state.cart);
...
>
  ...
  <div className="mt-2 relative rounded-md shadow-sm">
    ...
    />
      <button type="submit" className="ml-2 textblack text-sm leading-6 font-medium px-3 rounded-sm border border-black w-fit">Apply</button>
  </div>
      </div>
